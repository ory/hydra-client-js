...
# Contributing to Ory Ory Hydra JavaScript Client
...
_Please note_: We take Ory Ory Hydra JavaScript Client's security and our users' trust very seriously. If you believe you have found a security issue
in Ory Ory Hydra JavaScript Client, please responsibly disclose by contacting us at security@ory.sh.
...
Ory Hydra JavaScript Client's normal direction. A great way to
do this is via
[Ory Ory Hydra JavaScript Client Discussions](https://github.com/orgs/ory/discussions) or the
[Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/hydra-client-js/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get [answers to questions regarding Ory Ory Hydra JavaScript Client?](#communication)
...
- I want to talk to other Ory Ory Hydra JavaScript Client users. [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  Ory Hydra JavaScript Client.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/hydra-client-js)

- I would like updates about new versions of Ory Ory Hydra JavaScript Client.
...
[list of good first issues](https://github.com/ory/hydra-client-js/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a difference. This is something that everyone can do to help
  out Ory Ory Hydra JavaScript Client. Github stars help the project gain visibility and stand out.
...
- **Helping with open issues.** We have a lot of open issues for Ory Ory Hydra JavaScript Client and some of them may lack necessary information,
...
Check out [Ory Ory Hydra JavaScript Client Discussions](https://github.com/orgs/ory/discussions). This is a great place for in-depth discussions and lots of code examples, logs
and similar data.
...
If you want to receive regular notifications about updates to Ory Ory Hydra JavaScript Client, consider joining the mailing list. We will _only_ send
...
[in our chat](https://www.ory.sh/chat) before getting started to ensure your work is consistent with Ory Ory Hydra JavaScript Client's roadmap and
architecture.
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform commit history and helps structure the changelog.  
   Please refer to this [list of prefixes for Ory Hydra JavaScript Client](https://github.com/ory/hydra-client-js/blob/master/.github/semantic.yml) for an
   overview.
...
[Contributor License Agreement](https://cla-assistant.io/ory/hydra-client-js).
...
5. have signed our [Contributor License Agreement](https://cla-assistant.io/ory/hydra-client-js);
...
[docs](https://github.com/ory/hydra-client-js/tree/master/docs) folder. Generate API and configuration reference documentation using
`cd docs; npm run gen`.

For further instructions please head over to [docs/README.md](https://github.com/ory/hydra-client-js/blob/master/README.md).
...
git clone git@github.com:ory/ory/hydra-client-js.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/hydra-client-js.git
...
- Private harassment is also unacceptable. No matter who you are, if you feel you have been or are being harassed or made
  uncomfortable by a community member, please contact one of the channel ops or a member of the Ory Ory Hydra JavaScript Client core team
  immediately.
